        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            <li><i class="fas fa-phone"></i>&nbsp;+62 853-9901-4003</li>
                            <li><i class="fas fa-envelope"></i>&nbsp;danielruntuwene42@gmail.com</li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                <div class="col-lg-7 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            <li><a href=""><i class="fas fa-map-pin"></i>&nbsp;Store location</a></li>
                            {{-- <li><i class="ti-alarm-clock"></i> <a href="#">Daily deal</a></li> --}}
                            <li><a href="#"><i class="fas fa-user"></i>&nbsp;My account</a></li>
                            <li><a href="login.html#"><i class="fas fa-power-off"></i>&nbsp;Login</a></li>
                        </ul>
                    </div>
                    <!-- End Top Right -->
                </div>
